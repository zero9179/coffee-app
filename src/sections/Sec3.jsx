...
function Sec3() {
  ...
  return (
    <section className="bg-white w-screen min-h-screen px-6 md:px-16 py-16 relative overflow-hidden">
      {/* Section Heading */}
      <div className="text-center">
        <h1 className="textColor text-3xl sm:text-4xl md:text-5xl font-bold py-3">
          Enjoy a new blend Of Coffee style
        </h1>
        <p className="secColor text-base sm:text-lg md:text-xl mb-10 mt-4 text-gray-700">
