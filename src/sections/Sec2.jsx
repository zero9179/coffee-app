...
function Sec2() {
  return (
    <section
      id="sec2-container"
      className="bg-white w-screen min-h-[60%] lg:min-h-screen  px-6 md:px-16 py-10 flex flex-col md:flex-row items-center justify-center relative overflow-hidden"
    >
      {/* Left Text Content */}
      <div className="w-full md:w-[60%] mb-10 md:mb-0 text-center md:text-left">
        <h1 className="textColor text-3xl sm:text-4xl md:text-3xl lg:text-7xl font-semibold">
          Discover the best Coffee
        </h1>
        <p className="secColor my-8 text-sm sm:text-base md:text-md lg:text-2xl lg:w-[75%] text-gray-700">
